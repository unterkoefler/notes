...
var $author$project$Main$defaultModel = F4(
	function (dim, seed, isSyncing, errorMessage) {
		return {currentNoteId: $elm$core$Maybe$Nothing, dimensions: dim, errorMessage: errorMessage, isSyncing: isSyncing, notes: _List_Nil, seed: seed, showSidebar: true};
	});
...
var $author$project$Main$Model = F7(
	function (notes, currentNoteId, showSidebar, dimensions, seed, isSyncing, errorMessage) {
		return {currentNoteId: currentNoteId, dimensions: dimensions, errorMessage: errorMessage, isSyncing: isSyncing, notes: notes, seed: seed, showSidebar: showSidebar};
	});
var $elm$json$Json$Decode$bool = _Json_decodeBool;
var $elm$json$Json$Decode$andThen = _Json_andThen;
var $elm$json$Json$Decode$fail = _Json_fail;
var $NoRedInk$elm_uuid$Prng$Uuid$Uuid = function (a) {
	return {$: 'Uuid', a: a};
};
...
var $NoRedInk$elm_uuid$Prng$Uuid$fromString = function (text) {
	return $NoRedInk$elm_uuid$Prng$Uuid$isValidUuid(text) ? $elm$core$Maybe$Just(
		$NoRedInk$elm_uuid$Prng$Uuid$Uuid(
...
var $author$project$Main$Note = F4(
	function (contents, id, title, lastSynced) {
		return {contents: contents, id: id, lastSynced: lastSynced, title: title};
	});
...
var $author$project$Main$noteDecoder = A5(
	...
	A2($elm$json$Json$Decode$field, 'id', $NoRedInk$elm_uuid$Prng$Uuid$decoder),
...
var $author$project$Main$modelDecoder = A4(
	...
	A2(
		$elm$json$Json$Decode$field,
		'notes',
		$elm$json$Json$Decode$list($author$project$Main$noteDecoder)),
	A2(
		$elm$json$Json$Decode$field,
		'currentNoteId',
		$elm$json$Json$Decode$nullable($NoRedInk$elm_uuid$Prng$Uuid$decoder)),
...
var $author$project$Main$parseFlags = function (flags) {
	...
	var seedExtension = A2(
		...
		A2(
			...
			flags));
	var seed = A2($NoRedInk$elm_random_pcg_extended$Random$Pcg$Extended$initialSeed, seedInt, seedExtension);
	var makeModel = A2(
		$elm$core$Result$withDefault,
	...
	return A4(makeModel, dimensions, seed, false, $elm$core$Maybe$Nothing);
};
var $author$project$Main$init = function (flags) {
	var model = $author$project$Main$parseFlags(flags);
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				A2($elm$time$Time$every, 1 * 1000, $author$project$Main$SaveData)
			]));
};
var $author$project$Main$SyncedData = function (a) {
	return {$: 'SyncedData', a: a};
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'id',
				$NoRedInk$elm_uuid$Prng$Uuid$encode(note.id)),
				_Utils_Tuple2(
				'title',
				$elm$json$Json$Encode$string(note.title)),
				_Utils_Tuple2(
				'contents',
				$elm$json$Json$Encode$string(note.contents)),
				_Utils_Tuple2(
				'lastSynced',
				A2(
					$elm$core$Maybe$withDefault,
...
var $author$project$Main$syncDataEncoder = F2(
	function (notes, deletedNoteIds) {
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'notes',
					A2($elm$json$Json$Encode$list, $author$project$Main$noteEncoder, notes)),
					_Utils_Tuple2(
					'deletedNotes',
					A2($elm$json$Json$Encode$list, $NoRedInk$elm_uuid$Prng$Uuid$encode, deletedNoteIds))
				]));
	});
...
var $author$project$Main$syncedDataDecoder = A3(
	$elm$json$Json$Decode$map2,
	$elm$core$Tuple$pair,
	A2(
		$elm$json$Json$Decode$field,
	...
	A2(
		$elm$json$Json$Decode$field,
		'conflicts',
		$elm$json$Json$Decode$list($NoRedInk$elm_uuid$Prng$Uuid$decoder)));
var $author$project$Main$beginSync = F2(
	function (notes, deletedNoteIds) {
		return $elm$http$Http$post(
			{
				body: $elm$http$Http$jsonBody(
					A2($author$project$Main$syncDataEncoder, notes, deletedNoteIds)),
				expect: A2($elm$http$Http$expectJson, $author$project$Main$SyncedData, $author$project$Main$syncedDataDecoder),
				url: 'http://192.168.68.62:8001/sync'
			});
	});
var $author$project$Main$findWithRestHelp = F3(
	function (pred, xs, acc) {
		findWithRestHelp:
		while (true) {
			if (!xs.b) {
				return _Utils_Tuple2($elm$core$Maybe$Nothing, acc);
			} else {
				var x = xs.a;
				var rest = xs.b;
				if (pred(x)) {
					...
					xs = $temp$xs;
					acc = $temp$acc;
					continue findWithRestHelp;
				}
			}
		}
	});
var $author$project$Main$findWithRest = F2(
	function (pred, xs) {
		return A3($author$project$Main$findWithRestHelp, pred, xs, _List_Nil);
	});
var $author$project$Main$editNoteContents = F3(
	function (id, newContents, notes) {
		var _v0 = A2(
			$author$project$Main$findWithRest,
			function (n) {
				return _Utils_eq(n.id, id);
			},
			notes);
		var maybeNote = _v0.a;
		var notesWithoutCurrent = _v0.b;
		if (maybeNote.$ === 'Nothing') {
			return notes;
		} else {
			var noteToEdit = maybeNote.a;
			return A2(
				$elm$core$List$cons,
				_Utils_update(
					noteToEdit,
...
var $author$project$Main$editNoteTitle = F3(
	function (id, newTitle, notes) {
		var _v0 = A2(
			$author$project$Main$findWithRest,
			function (n) {
				return _Utils_eq(n.id, id);
...
var $author$project$Main$focusElement = function (id) {
	return A2(
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'notes',
				A2($elm$json$Json$Encode$list, $author$project$Main$noteEncoder, model.notes)),
				_Utils_Tuple2(
				'showSidebar',
				$elm$json$Json$Encode$bool(model.showSidebar)),
				_Utils_Tuple2(
				'currentNoteId',
				A2(
					$elm$core$Maybe$withDefault,
					$elm$json$Json$Encode$null,
					A2($elm$core$Maybe$map, $NoRedInk$elm_uuid$Prng$Uuid$encode, model.currentNoteId)))
			]));
};
...
var $NoRedInk$elm_uuid$Prng$Uuid$generator = A2($NoRedInk$elm_random_pcg_extended$Random$Pcg$Extended$map, $NoRedInk$elm_uuid$Prng$Uuid$Uuid, $NoRedInk$elm_uuid$Prng$Uuid$stringGenerator);
var $NoRedInk$elm_random_pcg_extended$Random$Pcg$Extended$step = $NoRedInk$elm_random_general$Random$General$step;
var $author$project$Main$newNote = function (model) {
	var title = 'Note ' + $elm$core$String$fromInt(
		$elm$core$List$length(model.notes) + 1);
	var _v0 = A2($NoRedInk$elm_random_pcg_extended$Random$Pcg$Extended$step, $NoRedInk$elm_uuid$Prng$Uuid$generator, model.seed);
	var id = _v0.a;
	var newSeed = _v0.b;
	return _Utils_Tuple2(
		{contents: '', id: id, lastSynced: $elm$core$Maybe$Nothing, title: title},
		newSeed);
};
var $elm$core$Basics$not = _Basics_not;
var $author$project$Main$noteContentsInputId = 'notes-content';
var $author$project$Ports$saveData = _Platform_outgoingPort('saveData', $elm$core$Basics$identity);
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'AddNote':
				var _v1 = $author$project$Main$newNote(model);
				var n = _v1.a;
				var newSeed = _v1.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							currentNoteId: $elm$core$Maybe$Just(n.id),
							notes: A2($elm$core$List$cons, n, model.notes),
							seed: newSeed
						}),
					$author$project$Main$focusElement($author$project$Main$noteContentsInputId));
			case 'EditNoteContents':
				var id = msg.a;
				var newContents = msg.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							notes: A3($author$project$Main$editNoteContents, id, newContents, model.notes)
						}),
					$elm$core$Platform$Cmd$none);
			case 'EditNoteTitle':
				var id = msg.a;
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							notes: A3($author$project$Main$editNoteTitle, id, newTitle, model.notes)
						}),
					$elm$core$Platform$Cmd$none);
			case 'SelectNote':
				var id = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							currentNoteId: $elm$core$Maybe$Just(id)
						}),
					$elm$core$Platform$Cmd$none);
			case 'CloseNote':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{currentNoteId: $elm$core$Maybe$Nothing}),
					$elm$core$Platform$Cmd$none);
			case 'ToggleSidebar':
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'SaveData':
				return _Utils_Tuple2(
					model,
					$author$project$Ports$saveData(
						$author$project$Main$modelEncoder(model)));
			case 'SyncData':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{isSyncing: true}),
					A2($author$project$Main$beginSync, model.notes, _List_Nil));
			case 'SyncedData':
				if (msg.a.$ === 'Ok') {
					var _v2 = msg.a.a;
					var notes = _v2.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{isSyncing: false, notes: notes}),
						$elm$core$Platform$Cmd$none);
				} else {
					var e = msg.a.a;
					var _v3 = A2($elm$core$Debug$log, 'error syncing', e);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
...
var $author$project$Main$baseFontSize = 12;
...
var $author$project$Main$findNote = F2(
	function (id, notes) {
...
var $author$project$Colors$primary = A3($mdgriffith$elm_ui$Element$rgb255, 56, 97, 80);
...
var $author$project$Main$header = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$Background$color($author$project$Colors$primary),
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text('Notey Notes')
					]))
			]));
};
...
var $author$project$Main$EditNoteContents = F2(
	function (a, b) {
		return {$: 'EditNoteContents', a: a, b: b};
	});
var $author$project$Main$EditNoteTitle = F2(
	function (a, b) {
		return {$: 'EditNoteTitle', a: a, b: b};
	});
...
var $author$project$Main$pct = F2(
	function (p, x) {
		return $mdgriffith$elm_ui$Element$px(((x * p) / 100) | 0);
	});
...
var $author$project$Main$noteEditor = F2(
	function (dims, _v0) {
		var id = _v0.id;
		...
		var w = A2(
			...
			A2(
				...
				800,
				A2($author$project$Main$pct, 60, dims.width)));
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$spacing(6),
					A2($mdgriffith$elm_ui$Element$paddingXY, 12, 24),
				...
				[
					...
					_List_fromArray(
						[
							...
							{
								label: $mdgriffith$elm_ui$Element$Input$labelHidden('Note title'),
								onChange: $author$project$Main$EditNoteTitle(id),
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$id($author$project$Main$noteContentsInputId)),
							$mdgriffith$elm_ui$Element$Font$size(14)
						]),
					{
						label: $mdgriffith$elm_ui$Element$Input$labelHidden('Note contents'),
						onChange: $author$project$Main$EditNoteContents(id),
						placeholder: $elm$core$Maybe$Just(
							A2(
								$mdgriffith$elm_ui$Element$Input$placeholder,
								_List_Nil,
								$mdgriffith$elm_ui$Element$text('The horrors of a blank page...'))),
						spellcheck: true,
						text: contents
					})
				]));
	});
var $author$project$Main$SelectNote = function (a) {
	return {$: 'SelectNote', a: a};
};
var $author$project$Colors$gray = A3($mdgriffith$elm_ui$Element$rgb255, 80, 80, 80);
var $author$project$Main$trimContents = F3(
	function (dims, ctx, s) {
		var width = function () {
			if (ctx.$ === 'Sidebar') {
				return (((25 * dims.width) / 100) | 0) - 24;
			} else {
				return (((75 * dims.width) / 100) | 0) - 48;
			}
		}();
		var breakpoint = $elm$core$Basics$floor(0.25 * width);
		return (_Utils_cmp(
			$elm$core$String$length(s),
			breakpoint) < 0) ? s : (A2($elm$core$String$left, breakpoint - 4, s) + '...');
	});
var $author$project$Main$notePreview = F3(
	function (dims, ctx, _v0) {
		var id = _v0.id;
		var contents = _v0.contents;
		var title = _v0.title;
		var label = A2(
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$text(
						A3($author$project$Main$trimContents, dims, ctx, contents)))
				]));
		return A2(
			$mdgriffith$elm_ui$Element$Input$button,
			_List_Nil,
			{
				...
				onPress: $elm$core$Maybe$Just(
					$author$project$Main$SelectNote(id))
			});
	});
var $author$project$Main$notePreviews = F3(
	function (dims, ctx, notes) {
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
			...
			A2(
				$elm$core$List$map,
				A2($author$project$Main$notePreview, dims, ctx),
				notes));
	});
var $author$project$Main$CloseNote = {$: 'CloseNote'};
var $author$project$Main$Sidebar = {$: 'Sidebar'};
...
var $author$project$Main$rectangleButton = F4(
	function (dims, onPress, lbl, color) {
		return A2(
			$mdgriffith$elm_ui$Element$Input$button,
			_List_fromArray(
				[
...
var $author$project$Colors$secondary = A3($mdgriffith$elm_ui$Element$rgb255, 74, 68, 45);
...
var $author$project$Main$sidebarToggler = function (showSidebar) {
	var label = showSidebar ? '<' : '>';
	return A2(
		$mdgriffith$elm_ui$Element$Input$button,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$Border$color($author$project$Colors$secondary),
				...
				A2(
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$moveDown(250),
							$mdgriffith$elm_ui$Element$Font$color($author$project$Colors$secondary),
							$mdgriffith$elm_ui$Element$Border$color($author$project$Colors$secondary),
							$mdgriffith$elm_ui$Element$Background$color(
			...
			]),
		{
			...
			onPress: $elm$core$Maybe$Just($author$project$Main$ToggleSidebar)
		});
};
var $author$project$Main$SyncData = {$: 'SyncData'};
var $author$project$Colors$highlight = A3($mdgriffith$elm_ui$Element$rgb255, 47, 48, 97);
var $author$project$Main$syncDataButton = F3(
	function (dims, isSyncing, buttonF) {
		return isSyncing ? A4(buttonF, dims, $elm$core$Maybe$Nothing, 'syncing...', $author$project$Colors$highlight) : A4(
			buttonF,
			dims,
			$elm$core$Maybe$Just($author$project$Main$SyncData),
			'Sync',
			$author$project$Colors$highlight);
	});
var $author$project$Main$sidebar = F4(
	function (dims, showSidebar, isSyncing, notes) {
		if (!showSidebar) {
			return $author$project$Main$sidebarToggler(showSidebar);
		} else {
			var w = A2(
				$mdgriffith$elm_ui$Element$minimum,
				160,
				A2(
					$mdgriffith$elm_ui$Element$maximum,
					300,
					A2($author$project$Main$pct, 25, dims.width)));
			return A2(
				$mdgriffith$elm_ui$Element$row,
				_List_fromArray(
					[
					...
					[
						...
						_List_fromArray(
							[
								...
								{
									label: $mdgriffith$elm_ui$Element$text('Notey Notes'),
									onPress: $elm$core$Maybe$Just($author$project$Main$CloseNote)
								}),
								A2(
								$mdgriffith$elm_ui$Element$column,
								_List_fromArray(
								...
								_List_fromArray(
									[
										A4(
										$author$project$Main$rectangleButton,
										dims,
										$elm$core$Maybe$Just($author$project$Main$AddNote),
										'Add note',
										$author$project$Colors$primary),
										A3($author$project$Main$syncDataButton, dims, isSyncing, $author$project$Main$rectangleButton),
										A3($author$project$Main$notePreviews, dims, $author$project$Main$Sidebar, notes)
									]))
							])),
						$author$project$Main$sidebarToggler(showSidebar)
					]));
		}
	});
var $author$project$Main$squareButton = F4(
	function (dims, onPress, lbl, color) {
		var w = A2(
			$mdgriffith$elm_ui$Element$maximum,
			300,
			A2($author$project$Main$pct, 30, dims.width));
		return A2(
			$mdgriffith$elm_ui$Element$Input$button,
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$Border$rounded(6),
					$mdgriffith$elm_ui$Element$width(w),
					$mdgriffith$elm_ui$Element$height(w)
				]),
			{
				label: A2(
					$mdgriffith$elm_ui$Element$paragraph,
...
var $author$project$Main$getBody = function (model) {
	var currentNote = A2(
		...
		function (id) {
			return A2($author$project$Main$findNote, id, model.notes);
		},
		model.currentNoteId);
	return A3(
		$mdgriffith$elm_ui$Element$layoutWith,
		{
			options: _List_fromArray(
				[
					...
					{
						backgroundColor: $elm$core$Maybe$Nothing,
						borderColor: $elm$core$Maybe$Just($author$project$Colors$white),
		...
		function () {
			if (currentNote.$ === 'Nothing') {
						...
						[
							...
							_List_fromArray(
								[
									...
									A2($author$project$Main$pct, 85, model.dimensions.width)),
									$mdgriffith$elm_ui$Element$centerX,
									$mdgriffith$elm_ui$Element$spacing(16)
								]),
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											A4(
											$author$project$Main$squareButton,
											model.dimensions,
											$elm$core$Maybe$Just($author$project$Main$AddNote),
											'Add note',
											$author$project$Colors$primary),
											A3($author$project$Main$syncDataButton, model.dimensions, model.isSyncing, $author$project$Main$squareButton)
										])),
									function () {
									...
									A3($author$project$Main$notePreviews, model.dimensions, $author$project$Main$Home, model.notes))
								]))
						]));
			} else {
				var n = currentNote.a;
				return A2(
					...
					_List_fromArray(
						[
							A4($author$project$Main$sidebar, model.dimensions, model.showSidebar, model.isSyncing, model.notes),
							A2($author$project$Main$noteEditor, model.dimensions, n)
						]));
			}
		}());
};
